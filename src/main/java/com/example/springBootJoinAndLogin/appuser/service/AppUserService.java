package com.example.springBootJoinAndLogin.appuser.service;

import com.example.springBootJoinAndLogin.appuser.entity.AppUser;
import com.example.springBootJoinAndLogin.appuser.store.AppUserRepository;
...
public class AppUserService implements UserDetailsService {
    ...
    public String signUpUser(AppUser appUser) {
        ...
        if (userExists) {
            ...
            // TODO id email not confirmed send confirmation email.
